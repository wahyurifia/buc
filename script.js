...
document.getElementById("loveIn").onclick = function() {if(fungsiAwal==0){audio.play();
fungsiAwal=1;loveIn.style="transition:all .7s ease;opacity:0";wallpaper.style="transform: scale(1.5);";ket.style="opacity:0";kot.style="opacity:0";setTimeout(mulainama,500)}}
...
async function menuju(){
    window.location = "http://api.whatsapp.com/send?phone=6285772355170&text=" + pesanwhatsapp;
    muncultombol3();
}
...
function muncultombol3(){
    fungtom=3;By.innerHTML="💌 Balas";Bn.style="display:none";Tombol.style="opacity:1;transform:scale(1)";}
